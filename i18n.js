const translations = {
  en: {
    ...
    selectRegion: "Select page region", selectRegionHint: "Choose an element on the page. This only saves a temporary location, not page text.",
    regionSelected: "A page region is selected. It will be read only when you create the capture.", useWholePage: "Use whole-page snapshot",
  ...
  "zh-CN": {
    ...
    selectRegion: "选择页面区域", selectRegionHint: "在页面中选择一个元素；此操作只保存临时位置，不读取页面文字。",
    regionSelected: "已选择页面区域；只有在创建采集时才会读取它。", useWholePage: "使用整页快照",
